...
Usage:
generate-repr-flood.py <queue_dir> <count_per_line> <files_to_write> <perm_string> <perm_string_len>
...
The values and timestamp will be the the current time as of the start of the test.

This can be used to stress-test the throughput on a relay, or the
speed of a cache.
